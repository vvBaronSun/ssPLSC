...
% Parameter optimization for the ssPLSC method
% Input:
% ---------------------
% data       - input data (same as that in PLSC.m)
% lambdaSet  - available lambda set
% gammaSet   - available gamma set
% TrialNum   - the number of epochs
% EEGsensors - the number of EEG sensors
% EMGsensors - the number of EMG sensors
%
% Output:
% -------------------
% Fixed_lambda1   - optimized lambda1 parameter
% Fixed_lambda2   - optimized lambda2 parameter
% Fixed_gamma1    - optimized gamma1 parameter
% Fixed_gamma2    - optimized gamma2 parameter
%
%
